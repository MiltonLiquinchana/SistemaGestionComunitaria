        ...
        <form action="" method="post" class="form_cobro_actividades">
            ...
            <div class="cont_forms">
                <div class="cont_contenedores">
                    ...
                    <div class="cont_campos_form_registro">
                        <label for="" class="label_campos_form_registro_socios">VALOR DEL CONSUMO:</label>
                        <input type="text" name="" id="" class="campo_form_registro_socios bloques"
                            placeholder="Ingrese el el nombre de la cuota">
                    </div>
                    ...
                    <div class="cont_campos_form_registro">
                        ...
                        <select name="" id="" class="campo_form_registro_socios lista">
                    ...
                    <div class="cont_campos_form_registro">
                        <label for="" class="label_campos_form_registro_socios">TIPO DE MULTA:</label>
                        <select name="" id="" class="campo_form_registro_socios lista">
                            <option value="">option 1</option>
                            <option value="">option 2</option>
                            <option value="">option 3</option>
                    ...
                    <div class="cont_campos_form_registro cont_lista_uno_tipo_actividad">
                        <label for="" class="label_campos_form_registro_socios">TIEMPO DE RETRASO:</label>
                        <input type="text" name="" id="" class="campo_form_registro_socios" placeholder="">
                        <button type="submit" class="btn_form_cobro_actividades">CALCULAR</button>
                    </div>
                    ...
                    <div class="cont_campos_form_registro">
                        <label for="" class="label_campos_form_registro_socios">TIPO DE DESCUENTO:</label>
                        <select name="" id="" class="campo_form_registro_socios lista">
                    ...
                    <div class="cont_campos_form_registro">
                        <label for="" class="label_campos_form_registro_socios">VALOR DESCUENTO:</label>
                        <input type="text" name="" id="" class="campo_form_registro_socios bloques"
                            placeholder="Ingrese el subtotal a pagar">
                    </div>

                    <div class="cont_campos_form_registro">
                        <label for="" class="label_campos_form_registro_socios">SUBTOTAL:</label>
                        <input type="text" name="" id="" class="campo_form_registro_socios bloques"
                            placeholder="Ingrese el subtotal a pagar">
                    </div>
