...
public class TipoConsumo {
    ...
    public TipoConsumo(int pk_tipoconsumo, String tipo_consumo, int limitem_cubico, double valor, double tarifa_basica, double tarifa_ambiente, double alcantarillado, int fk_comuna) {
