...
public class Comunero {
    ...
    public Comunero(int pk_comunero, String cedula, String primer_nombre, String segundo_nombre, String primer_apellido, String segundo_apellido, String telefono, String fecha_nacimiento, int edad, int fk_comuna, String direccion_vivienda, String referencia_geografica) {
