...
public class Consumo {
    ...
    public Consumo(int pk_consumo, String lectura_anterior, String lectura_actual, String fecha_lectura, String fecha_limite_pago, int consumo_mcubico, double total_pagar, int fk_medidor) {
