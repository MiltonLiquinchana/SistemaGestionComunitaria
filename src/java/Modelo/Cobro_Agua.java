...
public class Cobro_Agua {
    ...
    public Cobro_Agua(int pk_cobro_agua, Consumo consumo, Date fecha_cacelacion, String dias_retraso, Multas multas, Double valor_multa, Double totalpagar, int fk_estado_pagos) {
        ...
        this.fk_estado_pagos = fk_estado_pagos;
    }
    ...
    public int getFk_estado_pagos() {
        return fk_estado_pagos;
    }

    public void setFk_estado_pagos(int fk_estado_pagos) {
        this.fk_estado_pagos = fk_estado_pagos;
    }
